...
const translations = {
  en: {
    ...
    aboutText1:"Welcome to AgriConnect, your trusted partner in farming and agriculture!",
    aboutText2:"At AgriConnect, we are committed to empowering farmers with knowledge and resources to grow a better tomorrow. Our goal is to support you in making informed decisions about crops, their requirements, and effective agricultural practices—all in the language you are most comfortable with: English, Hindi, and Telugu.",
  ...
  hi: {
    ...
    aboutText1:
      "AgriConnect में आपका स्वागत है, कृषि और खेती में आपका विश्वसनीय साथी!",
    aboutText2:
      "AgriConnect में, हम किसानों को ज्ञान और संसाधनों के साथ सशक्त बनाने के लिए प्रतिबद्ध हैं ताकि वे एक बेहतर कल उगा सकें। हमारा लक्ष्य आपको फसलों, उनकी आवश्यकताओं और प्रभावी कृषि प्रथाओं के बारे में सूचित निर्णय लेने में समर्थन करना है—वह भी आपकी पसंदीदा भाषा में: अंग्रेजी, हिंदी और तेलुगु।",
    aboutText3:
  ...
  te: {
    ...
    aboutText1:
      "AgriConnect కు స్వాగతం, రైతు మరియు వ్యవసాయం లో మీ విశ్వసనీయ భాగస్వామి!",
    aboutText2:
      "AgriConnect లో, మేము రైతులను మంచి భవిష్యత్తును పెంచేందుకు జ్ఞానం మరియు వనరులతో శక్తివంతం చేయడంలో నిబద్ధంగా ఉన్నాము. మా లక్ష్యం మీరు పంటలు, వాటి అవసరాలు మరియు సమర్ధవంతమైన వ్యవసాయ అభ్యాసాల గురించి సూత్రసంగతమైన నిర్ణయాలు తీసుకోవడంలో మద్దతు ఇవ్వడమే—మీరు అత్యంత సౌకర్యంగా ఉన్న భాషలో: ఆంగ్లం, హిందీ, మరియు తెలుగు.",
    aboutText3:
    ...
    aboutText4:
      "మమ్మల్ని ఎందుకు ఎంచుకోవాలి? రైతు-కేంద్రిత దృష్టికోణం:మేము మీ అవసరాలు మరియు సవాళ్లను ప్రాధాన్యం ఇస్తున్నాము. అందుబాటులో ఉన్న సమాచారం:మన మల్టీలాంగ్వేజ్ ప్లాట్‌ఫారమ్ ప్రతి రైతు ఆవశ్యకమైన మార్గదర్శకత్వం పొందగలుగుతుందని నిర్ధారిస్తుంది.నాణ్యత హామీ:మేము అందించే అన్ని ఉత్పత్తులు పరీక్షించబడి, ఉత్తమ ఫలితాల కోసం నమ్మకమైనవి.సాధారణమైన పరిష్కారాలు:ఆధునిక వ్యవసాయ సాంకేతికతలు మరియు ఉత్పత్తులను అందరికీ అందుబాటులో ఉంచడమే మా లక్ష్యం.మమ్మల్ని చేరి ఒక ప్రకాశవంతమైన భవిష్యత్తును పండించడంలో సహకరించండి. AgriConnect తో కలిసి పండిద్దాం—కారణం మీ విజయం మన లక్ష్యం.ఇంకా తెలుసుకోవడానికి మరియు మీ కోసం ఎదురు చూస్తున్న వనరులను అన్వేషించడానికి ఈ రోజు మనతో సంప్రదించండి!",
